...
--------------------------------------------------------------------------------------
*/
-- Limpiar datos existentes respetando el orden de las claves foráneas
DELETE FROM [cafe].[SCA]
DELETE FROM [cafe].[LoteCafe]
DELETE FROM [origen].[Region]
DELETE FROM [origen].[Productor]
DELETE FROM [origen].[Pais]
DELETE FROM [origen].[TipoProductor]
DELETE FROM [maestra].[Variedad]
DELETE FROM [maestra].[Tueste]
DELETE FROM [maestra].[Proceso]
